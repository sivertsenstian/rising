...
import { Race, raceName } from "@/utilities/races";
...
const buildorder = computed(() => builds.buildorders.find(b => b.slug === route.params.id));
...
const playerRaces = [Race.GDF, Race.Dynasty];
const opponentRaces = [
  Race.Random,
  Race.GDF,
  Race.Dynasty,
    ...
    <v-container fluid class="primary-surface">
      <v-sheet
        ...
        v-if="
          builds.data &&
          builds.data.edit?.id &&
          builds.canEdit(String(builds.data.edit.id))
        ">
        <v-btn
                          ...
                          <tr v-for="(item, index) in builds.data.edit.games">
                            ...
                            <td>
                              <v-text-field
                                ...
                                variant="underlined"
                                v-model="item.id"
                                placeholder="e.g. a youtube video explaining the build"></v-text-field>
                            </td>
                            <td>
                              <v-text-field
                                hide-details
